...
namespace Zhaoxi.RedisSample.Blog.Controllers
{
    ...
    public class Article04Controller : ControllerBase
    {
        ...
        public Article04Controller(IRedisDatabase redisDatabase, IMapper mapper)
        {
        ...
        public async Task<IActionResult> Get(long id)
        {
            ...
            var pageView = await _redis.SortedSetAddIncrementAsync(ArticleConstant.ArticlesPageView, id, 1);
        ...
        public async Task<IActionResult> Delete(long id)
        {
            ...
            await _redis.SetRemoveAsync(ArticleConstant.ArticleTags, id);
            await _redis.SortedSetRemoveAsync(ArticleConstant.ArticlesPageView, id);
            return Ok();
        }
        ...
        public async Task<IActionResult> GetArticles([FromQuery]ArticleParameter parameter)
        {
            ...
            var ids = await _redis.SortedSetRangeByRankWithScoresAsync<long>(ArticleConstant.ArticlesPageView, start, end);
